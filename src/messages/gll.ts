...
import {NmeaDataValidity, NmeaModeIndicator} from '../enums';
import {NmeaSentenceType} from '../mnemonics';

import {Lat, Lng, Str, Time} from '../decode-encode';

/**
 * GLL - Geographic Position – Latitude/Longitude
 */
@Sentence(NmeaSentenceType.GLL)
export class NmeaMessageGll extends NmeaMessage {
    @Lat latitude?: number;
